...
### 🔴 P0
- [x] flutter analyze 오류 0개 (No issues found)
- [x] 전체 기능 시나리오 테스트 (캐시 연동 확인 완료)
- [x] 버그 수정
- [x] 코드 리팩토링 (중복 제거)
- [x] 주석 및 파일 요약 전체 점검
...
- [x] README.md 최종 업데이트
- [ ] 스크린샷 / 데모 영상 촬영
- [x] 포트폴리오용 설명 작성 (README 포트폴리오 포인트 섹션)
- [ ] 발표 자료 준비
- [x] GitHub 정리 (브랜치 week-05, 태그 v1.0.0)
...
```
main                     ← 최종본
  └── week-01~05         ← 주차별 작업 브랜치 (완료)
  └── feat/phase-6-...   ← 기능 브랜치 (완료)
```
